...
- `pyproject.toml`: custom Vercel ASGI entrypoint `backend.app.main:app`.
...
| Vercel configuration parse assertions | JSON/TOML syntax and expected framework, build, duration and entrypoint fields passed. |
