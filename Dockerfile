...
COPY scripts/start.sh scripts/smoke.py scripts/planning_smoke.py scripts/planning_profile.py scripts/scenario_smoke.py scripts/solver_smoke.py scripts/workflow_smoke.py ./scripts/
